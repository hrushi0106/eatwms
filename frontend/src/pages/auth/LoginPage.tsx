          ...
          <div className="bg-slate-800/30 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/30">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white text-sm font-semibold">Dashboard</div>
                  <div className="text-slate-400 text-xs">Good Morning!</div>
                </div>
              </div>
              <div className="text-xs text-slate-400">Here's your daily overview</div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-slate-700/30 rounded-xl p-4">
                ...
                <div className="text-white text-lg font-semibold">09:30 AM</div>
              </div>
              <div className="bg-slate-700/30 rounded-xl p-4">
                <div className="flex items-center justify-between mb-2">
                ...
                <div className="text-white text-lg font-semibold">8h 30m</div>
              </div>
            </div>

            {/* Team Section */}
            <div className="mb-6">
              <div className="text-slate-300 text-sm font-medium mb-3">Team</div>
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-green-500 rounded-full"></div>
                  <div className="text-slate-300 text-xs">Present</div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-orange-500 rounded-full"></div>
                  <div className="text-slate-300 text-xs">Reports</div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-purple-500 rounded-full"></div>
                  <div className="text-slate-300 text-xs">Settings</div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="text-slate-300 text-sm font-medium mb-3">Weekly Activity</div>
              <div className="flex items-end gap-2 h-20">
                <div className="w-6 bg-blue-500 rounded-t h-16"></div>
                <div className="w-6 bg-blue-400 rounded-t h-12"></div>
                <div className="w-6 bg-blue-600 rounded-t h-20"></div>
                <div className="w-6 bg-blue-300 rounded-t h-8"></div>
                <div className="w-6 bg-blue-500 rounded-t h-14"></div>
                <div className="w-6 bg-blue-400 rounded-t h-18"></div>
                <div className="w-6 bg-blue-200 rounded-t h-4"></div>
              </div>
